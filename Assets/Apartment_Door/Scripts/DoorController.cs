...
public class DoorController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (playerInZone)
        {
            ...
            {
                txtToDisplay.GetComponent<TMPro.TextMeshProUGUI>().text = "Press 'E' to Close";
                doorCollider.enabled = false;
            }
            else if (doorState == DoorState.Closed || gotKey)
            {
                txtToDisplay.GetComponent<TMPro.TextMeshProUGUI>().text = "Press 'E' to Open";
                doorCollider.enabled = true;
            }
            else if (doorState == DoorState.Jammed)
            {
                txtToDisplay.GetComponent<TMPro.TextMeshProUGUI>().text = "Needs Key";
                doorCollider.enabled = true;
            }
        }
